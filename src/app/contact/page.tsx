...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showSuccessToast('Message sent successfully! We will contact you soon.');
      setIsSubmitting(false);
      setIsSuccess(true);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-indigo-100 max-w-3xl mx-auto mb-8">
              Ready to start your learning journey? Have questions about our services? 
              ...
              {isSuccess ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 border text-black border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white placeholder-gray-500"
                  ...
                  <motion.button
                    ...
                    className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-4 rounded-lg font-semibold hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
            ...
            >
              <div>
                ...
                <p className="text-lg text-gray-600 mb-8">
                  We&apos;re here to help you achieve your learning and career goals. 
