...
import { getEnquiries } from '@/lib/database';

// ----------------------
// Update Type: Changed
// Description: Updated Enquiries Page to use new database function and improved UI
// Updated By: Himanshu
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Contact Enquiries</h1>
              <p className="text-sm sm:text-base text-gray-600 mt-1 sm:mt-2">Manage and track all contact form submissions</p>
            </div>
            <div className="flex items-center">
              <div className="bg-white px-4 py-2 rounded-lg shadow-sm border w-full sm:w-auto">
                <span className="text-xs sm:text-sm text-gray-600">Total Enquiries:</span>
                <span className="ml-2 font-semibold text-base sm:text-lg text-gray-900">{enquiries.length}</span>
              </div>
            </div>
          </div>
        </div>
          ...
          {enquiries.length === 0 ? (
            ...
            <div className="divide-y divide-gray-200">
              {enquiries.map((enquiry) => (
                <div key={enquiry.id} className="p-4 sm:p-6 hover:bg-gray-50 transition-colors">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      {/* Name and badges */}
                      <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-3">
                        <h3 className="text-base sm:text-lg font-medium text-gray-900">{enquiry.name}</h3>
                      ...
                      {enquiry.message && (
                        <div className="bg-gray-50 rounded-lg p-3 sm:p-4 mb-4">
                          ...
                          <p className="text-xs sm:text-sm text-gray-700 whitespace-pre-wrap">{enquiry.message}</p>
                        </div>
                      )}
