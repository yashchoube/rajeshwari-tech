...
import { getBlogBySlugAdmin } from '@/lib/database';

// ----------------------
// Update Type: Changed
// Description: Updated Admin Preview Page to use new database function and layout
// Updated By: Himanshu
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <div className="p-8">
              ...
              <div className="prose prose-lg max-w-none blog-content-wrapper">
                ...
                ` }} />
                <div className="text-gray-700 leading-relaxed" dangerouslySetInnerHTML={{ __html: sanitizeHtml(blog.content) }} />
              </div>
