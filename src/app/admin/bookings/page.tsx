...
// ----------------------
// Update Type: Added
// Description: Created new Bookings Page to manage demo class bookings
// Updated By: Himanshu
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-6 sm:mb-8">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div>
                            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Demo Bookings</h1>
                            <p className="text-sm sm:text-base text-gray-600 mt-1 sm:mt-2">Manage and track all demo class bookings</p>
                        </div>
                        <div className="flex items-center">
                            <div className="bg-white px-4 py-2 rounded-lg shadow-sm border w-full sm:w-auto">
                                ...
                                <span className="ml-2 font-semibold text-base sm:text-lg text-gray-900">{bookings.length}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-lg shadow">
                    <div className="px-6 py-4 border-b border-gray-200">
                        ...
                        <p className="text-sm text-gray-600">Manage demo class requests</p>
                    </div>

                    {bookings.length === 0 ? (
                        <div className="text-center py-12">
                            <h3 className="mt-2 text-sm font-medium text-gray-900">No bookings yet</h3>
                            <p className="mt-1 text-sm text-gray-500">Demo class bookings will appear here.</p>
                        </div>
                    ) : (
                                    ...
                                    <div className="flex items-start justify-between">
                                        <div className="flex-1">
                                            ...
                                            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-3">
                                                <h3 className="text-base sm:text-lg font-medium text-gray-900">{booking.name}</h3>
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-4">
                                                ...
                                                <div className="space-y-1">
                                                    <p className="text-xs sm:text-sm text-gray-600">
                                                        <span className="font-medium">Experience:</span> {booking.experience}
                                                    </p>
                                                    <p className="text-xs sm:text-sm text-gray-600">
                                                        <span className="font-medium">Preferred Time:</span> {booking.preferred_time}
                                                    </p>
                                                    <p className="text-xs sm:text-sm text-gray-600">
                                                        <span className="font-medium">Submitted:</span> {new Date(booking.created_at).toLocaleDateString()}
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            {booking.message && (
                                                <div className="bg-gray-50 rounded-lg p-3 sm:p-4 mb-4">
                                                    <h4 className="text-xs sm:text-sm font-medium text-gray-900 mb-2">Message:</h4>
                                                    <p className="text-xs sm:text-sm text-gray-700 whitespace-pre-wrap">{booking.message}</p>
                                                </div>
                                            )}
