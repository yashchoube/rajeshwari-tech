    ...
    <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
      ...
      <div className="flex items-center justify-between">
        ...
        <select
          ...
          disabled={isUpdating}
          className="text-xs border text-gray-900 border-gray-300 rounded px-2 py-1 bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:opacity-50"
        >
