...
// ----------------------
// Update Type: Changed
// Description: Enhanced editor with image cropping, emoji picker, and improved toolbar controls
// Updated By: Himanshu
...
export default function RichTextEditor({ value, onChange }: RichTextEditorProps) {
  ...
  return (
    <div className="border rounded-lg shadow-sm">
      {/* Enhanced Toolbar */}
      <div className="flex flex-wrap items-center gap-1 p-3 border-b bg-gradient-to-r from-gray-50 to-gray-100 text-gray-700">
        {/* Undo/Redo */}
      ...
      {cropImage && (
        <ImageCropper
          ...
          onCropComplete={(croppedBlob) => {
            if (pendingFile) {
              const file = new File([croppedBlob], pendingFile.name, { type: pendingFile.type });
              onUploadImage(file);
            }
            setCropImage(null);
            setPendingFile(null);
      ...
      <div
        ...
        data-placeholder="Start writing your blog post here... Use Ctrl+B for bold, Ctrl+I for italic, Ctrl+U for underline"
      />
